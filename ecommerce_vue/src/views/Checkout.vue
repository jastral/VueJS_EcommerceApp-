    ...
    <div class="page-checkout">
        <div class="columns is-multiline">
            ...
            <div class="column is-12 box">
                ...
                <p class="has-text-grey mb-4"> * All fields are mandatory</p>
...
export default {
    ...
    mounted() {
        ...
        if (this.cartTotalLength > 0) {
            this.stripe = Stripe('pk_test_51IrPPoSDwYCuIECRuTBrrlBiemDIlyGbL5w1218LEsHfyI159Gv8Xop4LEmDqmOxM8p00558QCp2snlDLTCdAYQd00JoAP2QhO')
